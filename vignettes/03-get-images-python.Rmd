...
- Change to use a ZIP file of imaes we want - merge files with paths
- Show how to find plot data using Globus/Workbench
- 

## Objective: Find sensor names and retrieve files

This vignette shows how to retrieve the list of available sensor names through the API as well as retrieving files.

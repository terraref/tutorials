...
If you are following along using the vignette examples, and not your own data, there won't be any files to download since our search didn't return any.
By adding the following assignment statement you will be able to download some of the publicly available images.
If you are not using these examples verbatum, do not use the following assignment statement as it will give you incorrect (aka bad) results.

```{python eval=FALSE}
# Use the following code *only* if you are following these examples. Otherwise you will get incorrect results
...
The following shows how to download the image files.
...
Below are some examples of images captured approximately one month apart [^1] [^2]

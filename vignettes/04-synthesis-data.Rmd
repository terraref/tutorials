...
trait_canopy_height <- betydb_query(table     = "search", 
                      ...
                      date      = "~2017",
                      limit     =  "none")
trait_canopy_height2 = trait_canopy_height %>% 
...
trait_weather_df <- full_join(trait_canopy_height2, daily_values, by = "day") %>% 
...
trait_canopy_cover2 <- trait_canopy_cover %>% 
  mutate(day = as.Date(raw_date))
```
...
sensor_trait_df <- left_join(trait_canopy_cover3, greenness_df, by = "day")

...
Although we want to make these data broadly available, the remainder of the dataset requires an account to use so we can keep track of who and how many people are using it, and can contact users with their provided email addresses. Information for getting a beta user account is available in [section 1.1.2](https://terraref.github.io/tutorials/index.html). 

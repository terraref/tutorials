...
* use `pip install terrautils` to install the terrautils Python library
...
We are only going to be working with public data in this tutorial, so we can 
use an empty API key.

...
# Download all files from Clowder
...
for (i in 1:length(outputs)) {
  ...
  vals <- c(vals, metdata$`par_sensor/Sensor_Photosynthetically_Active_Radiation`)
}

plot(time, vals, type = 'p')
=======
api_url <- "https://terraref.ncsa.illinois.edu/clowder/api"
spaces <- fromJSON(paste0(api_url, '/spaces'))
...
download.file(paste0(api_url, '/datasets/', ncfiles$id[1], '/files'), destfile = ncfiles$filename[1])

...
For this tutorial, you will be uploading your metadata to a test database. A tutorial on how to set up a local instance of a test database can be found in this [metadata folder](https://github.com/terraref/tutorials/tree/test_db_tutorial/metadata).

---
title: 'Metadata Upload Tutorial Part 2: Associating new experiments, sites, treatments, cultivars and citations in BETYdb'
...
The objective of this tutorial is to demonstrate how to associate the metadata that you have added to the traits database. Each site that you add must be associated with an experiment, cultivar, and citation. Each treatment added must be associated with an experiment. 

This tutorial should be completed after `Metadata Upload Tutorial Part 1: Adding new metadata to BETYdb`.

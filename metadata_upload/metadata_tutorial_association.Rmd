...
The following lines should be uncommented when you are done testing:

250 (associate experiments with sites), 288 (associate experiments with treatments), 322 (associate sites with cultivars), 354 (associate citations with sites)

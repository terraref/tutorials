...
* Database connection parameters 
  ...
  * see more information on how to create this file below
...
## user will need to pass in google sheet URL at command line 
# args[1] : google sheet URL #https://docs.google.com/spreadsheets/d/1c_5j7q3TO6gQ24KSopE-_LXA5HhfsUEqMupckGZAbo8/edit#gid=0
...
## read in google sheet URL
url <- args[1]

## get key from URL
key <- extract_key_from_url(url)

## register sheet # create google sheet object
gs_obj <- key %>% gs_key(lookup = FALSE)

## db_connection sheet
db_connection <- gs_obj %>% gs_read(ws = 'db_connection')
...
## create database connection using parameters from db_connection sheet
dbcon <- dbConnect(RPostgres::Postgres(),
                   dbname = db_connection$name,

...
The following lines should be uncommented when you are ready to upload data to the database:

263 (add experiments), 286 (add sites), 309 (add treatments), 337 (add species), 388 (add cultivars), 406 (add citations)

...
The `Metadata Upload Tutorial Part 2: Associations` tutorial should be run after completing this tutorial and all new metadata has been added (see below for more details). The tutorial will cover how to associate the metadata that you add.

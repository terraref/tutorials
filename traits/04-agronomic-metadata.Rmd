...
sites <- (betydb_query(table="sites", limit="none", betyurl=betyurl, key=betykey, api_version="beta")
...
leaflet() %>% addTiles() %>% addPolygons(data=sites_poly, color="red") %>% addMarkers(data=sites_point)

...
```sh
wget -O sorghum.json
   "https://terraref.ncsa.illinois.edu/bety/api/beta/species?genus=Sorghum&key=9999999999999999999999999999999999999999"
```
...
> Do you know what `cat ~/.betykey_public`. Run the command and see what it outputs in your shell.

> How can you look at the files?

Hint: search what a json file is

### Accessing API data using the R jsonlite package

JSON content can be converted into a R object using the fromJSON function.
Access the 'data' element of the R object to get the data frame.
...
sorghum.dataframe <- sorghum$data
```
